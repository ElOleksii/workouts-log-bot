...
export type SetWhereInput = {
    ...
    weight?: Prisma.IntFilter<"Set"> | number;
...
export type SetScalarWhereWithAggregatesInput = {
    ...
    weight?: Prisma.IntWithAggregatesFilter<"Set"> | number;
};
...
export type SetOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "exerciseId" | "reps" | "weight", ExtArgs["result"]["set"]>;
...
export interface SetFieldRefs {
    ...
    readonly weight: Prisma.FieldRef<"Set", 'Int'>;
}
/**
 * Set findUnique
 */
